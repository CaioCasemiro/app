...
export default function Bombons(){
    ...
    const bombons = [
        { id: 1, nome: "Morango", preco: "R$ 12,00", img: "/bombomMorango12.jpeg" },
        { id: 2, nome: "Uva", preco: "R$ 12,00", img: "/bombomUva12.jpeg" },
        { id: 3, nome: "Geleia de morango", preco: "R$ 12,00", img: "/geleiaMorango12.jpeg" },
    ]
